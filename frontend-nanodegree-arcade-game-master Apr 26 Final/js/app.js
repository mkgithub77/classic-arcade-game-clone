...
var Enemy = function(init_x,y,speedRate) {
    ...
    this.initx = init_x;             //Enemy initial x position
    this.x = init_x;
    this.y = y;
...
var Player = function() {
    ...
    this.x = PLAYER_InitX;
    this.y = PLAYER_InitY;
    this.h_step = 15;  //set the increment of horizontal step of each arrow press
    this.v_step = 15;  //set the increment of vertical step of each arrow press
    this.width = 68;
    this.height = 78;
};
...
Player.prototype.checkIfBoundaryIsReached = function() {
    ...
    if (this.y <= 55){  //check if player had reached the top
        ...
        document.addEventListener('click', function(){
            ...
            ctx.clearRect(0,0,500,500);  //clear screen after reset
        })
    }    
